...
/**
 * Topic -> Stream -> Filter/FilterNot -> SelectKey
 *
 ...
 *
 */
public class StreamSelectKey {
    private static final Logger logger = LoggerFactory.getLogger(StreamSelectKey.class);
    ...
    private static Topology createTopology() {
        ...
        KStream<Long, Customer> customerKStream = builder.stream(StreamConstants.INPUT_TOPIC,
                ...
                .selectKey(((customerId, customer) -> customer.getAccountDetails().getAccountNumber()));
        customerKStream.foreach(((customerId, customer) -> logger.info(String.format("%s : %s", customerId, customer.getAccountDetails().toString()))));
