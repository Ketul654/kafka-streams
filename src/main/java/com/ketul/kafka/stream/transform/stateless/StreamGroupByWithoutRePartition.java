...
/**
 * Topic -> Stream -> Filter -> GroupByKey -> Foreach to print stream data
 * <p>
 ...
 */
public class StreamGroupByWithoutRePartition {
    private static final Logger LOGGER = LoggerFactory.getLogger(StreamGroupByWithoutRePartition.class);
